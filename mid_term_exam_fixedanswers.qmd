...
-   The constant term provides a predictive average on the European Parliament Feeling Thermometer when an individual is not female (female = 0) and education = 0, however Education cannot be coded = 0.
    ...
    FIXED ANSWER: No, the constant term is not useful to interpret on its own.

-   The constant term provides a predictive average on the European Parliament Feeling Thermometer when an individual is not female (female = 0) and education = 0, however Education cannot be coded = 0, making it not useful to interpret on its own.
...
-   NO
-   FIXED ANSWER: YES, why?
    -   1 is coded as 0 years of education
...
-   FIXED ANSWER: The coefficient estimate of 20 for the education variable suggest that **on average** each one unit increase in the **level of education is associated** with a 20 point increase on the European Parliament Feeling Thermometer, **holding all else constant.**
...
-   FIXED ANSWER: No, it is not possible to conclude that the negative coefficient on females may be a result of females having less education because education is accounted for in the model.
...
-   why? Zuri and Teddy offer different explanations for the substantive meaning, but they logic still makes sense

    -   You gotta give credit to the logical explanation and its sound.
